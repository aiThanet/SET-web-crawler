...
def getPrice(symbol):
    ...
    diffL52 = (price - lowest_price_in52week)
    ...
    for row in price_table:
        price_his.append(row.select('td')[1].text.strip())
...
def main():
    ...
    display_key = ["sym", "dy", "price", "punpon",
                   "h52", "l52", "diff", 'avg_pe', 'l_pe','price_his', 'score','is_SET100']
